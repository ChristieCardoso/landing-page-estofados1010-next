...
export default function AboutUs() {
  return (
    <div className="relative isolate overflow-hidden py-24 sm:py-32">
      <a id="about" />
      <h2 className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Sobre nós</h2>
      ...
      >
        <div
          className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-[#1c7ed6] to-[#776fff] opacity-20"
          style={{
            clipPath:
