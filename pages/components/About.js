        ...
        <div className="flex flex-wrap items-center">
          <div className="w-full px-4 mb-10 md:w-1/2 lg:mb-0 ">
            <h2 className="mb-4 text-2xl font-bold text-gray-900">
              Bem-vindo à Estofados 10/10, onde a excelência encontra a inovação na arte de limpar e higienizar estofados.
            </h2>
            ...
            <ul className="columns-2">
              <li className="flex items-center mb-4 text-base text-gray-600">
                <span className=" mr-3 text-blue-200">
                  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-trophy" viewBox="0 0 20 16">
                ...
                <span className="text-3xl text-blue-700 mr-3">2</span>
              ...
              <li className="flex items-center mb-4 text-base text-gray-600">
                ...
                <span className="text-3xl text-blue-700 mr-2">+50</span>
