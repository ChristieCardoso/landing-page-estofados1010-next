      ...
      <div className="justify-center flex-1 max-w-6xl py-4 mx-auto lg:py-6 md:px-6">
        ...
        >
          <div className="p-6">
            ...
            <p className="mb-2 text-lg text-center text-gray-800"> Otimo atendimento, serviço bem feito e bom custo-beneficio. A empresa atendeu muito bem.</p>
            <div>
          ...
          <div className="p-6">
            ...
            <p className="mb-2 text-lg text-center text-gray-800"> Fiquei muito Satisfeita!!!! São pontuais, os prestadores educados e o serviço muito bem executado.</p>
            <div>
